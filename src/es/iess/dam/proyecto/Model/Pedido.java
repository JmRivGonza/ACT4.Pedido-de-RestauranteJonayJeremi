...
public class Pedido {
   ...
   public Pedido(int id, String nombre, String Descripcion, String ingredientes, double precio, int cantidad, double calificacion, Estado_Del_Pedido estado, Descuentos descuento) {
      this.id = id;
      this.nombre = nombre;
